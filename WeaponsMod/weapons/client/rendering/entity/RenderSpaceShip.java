...
public class RenderSpaceShip extends Render
{
	 ...
	 */
	public void renderBoat(EntitySpaceShip entity, double par2, double par4, double par6, float par8, float par9)
	{
		GL11.glPushMatrix();
	...
	{
		this.renderBoat((EntitySpaceShip)par1Entity, par2, par4, par6, par8, par9);
	}
}
