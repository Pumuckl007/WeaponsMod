...
public class BlockItemWeaponCarverRender implements IItemRenderer {

    private ModelWeaponCarver model;

    public BlockItemWeaponCarverRender() {

        model = new ModelWeaponCarver();
    }
