...
import weapons.client.models.gun.ModelFlameThrower;
...
public class ItemFTRender extends Render implements IItemRenderer {

	private ModelFlameThrower testModel;

	public ItemFTRender() {

		testModel = new ModelFlameThrower();
	}
	...
	private void renderGun(float x, float y, float z, float rotx, float roty, float rotz, float scale) {
		...
		// Bind texture
		FMLClientHandler.instance().getClient().renderEngine.bindTexture("/mods/weapons/textures/models/ft.png");
