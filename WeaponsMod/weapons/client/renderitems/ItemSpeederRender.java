...
public class ItemSpeederRender extends Render implements IItemRenderer {

	private ModelSpeeder testModel;

	public ItemSpeederRender() {

		testModel = new ModelSpeeder();
	}
