...
import weapons.client.models.gun.ModelRocketLauncher;
...
public class ItemRocktlauncherRender extends Render implements IItemRenderer {

	private ModelRocketLauncher testModel;

	public ItemRocktlauncherRender() {

		testModel = new ModelRocketLauncher();
	}
