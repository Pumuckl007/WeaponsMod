...
import weapons.client.models.armor.ModelJetBoot;
...
public class ItemJetBootsRender extends Render implements IItemRenderer {

	private ModelJetBoot modleJetBoots;

	public ItemJetBootsRender() {

		modleJetBoots = new ModelJetBoot();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		switch (type) {
			case ENTITY: {
				renderBoots(1F, 0F, 0F, 0F, 0F, 0F, 0.50F);
				return;
			}
			case EQUIPPED: {
