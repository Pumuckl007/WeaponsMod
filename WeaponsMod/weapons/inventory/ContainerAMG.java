...
public class ContainerAMG extends Container {

    private final int PLAYER_INVENTORY_ROWS = 3;
    private final int PLAYER_INVENTORY_COLUMNS = 9;
    TileEntityAntiMaterGenerator tile;

    public ContainerAMG(InventoryPlayer inventoryPlayer, TileEntityAntiMaterGenerator tile) {

    	this.tile = tile;
        this.addSlotToContainer(new SlotPower(tile, TileEntityAntiMaterGenerator.INPUT, 58, 6));
        this.addSlotToContainer(new SlotOne(tile, TileEntityAntiMaterGenerator.FUEL_SLOT, 80, 62));
