...
public class EntitySpaceShip extends Entity
{
	...
	public EntitySpaceShip(World par1World)
	{
		super(par1World);
	...
	public EntitySpaceShip(World par1World, double par2, double par4, double par6)
	{
		this(par1World);
			...
			if (!this.worldObj.isRemote)
			{
				...
				if (list != null && !list.isEmpty())
				{
					for (l = 0; l < list.size(); ++l)
					{
						...
						if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof EntitySpaceShip)
						{
	...
	public void updateflying(){
		if(this.riddenByEntity instanceof EntityPlayer){
			...
			double x = this.posX + startX;
			double y = this.posY + startY;
			double z = this.posZ + startZ;
			if(this.lastY != 0){
				if(this.posX < this.lastY){
					this.moveFlying((float)this.posX, (float)this.lastY, (float)this.posZ);
				}
			}
			this.moveFlying((float)x, (float)y, (float)z);
			this.motionX = volocityX / 2;
			this.motionY = volocityY / 2;
			this.motionZ = volocityZ / 2;
	...
	public void updateRiderPosition()
	{
		if (this.riddenByEntity != null)
		{
			...
			this.riddenByEntity.setPosition(this.posX + d0, this.posY + this.getMountedYOffset() + this.riddenByEntity.getYOffset() + 1, this.posZ + d1);
		}
