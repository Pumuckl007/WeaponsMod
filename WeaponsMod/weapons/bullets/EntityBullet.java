...
public class EntityBullet extends Entity implements IProjectile
{
	...
	public EntityBullet(World par1World, EntityLiving par2EntityLiving, float par3, double damage1)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = par2EntityLiving;
				...
				for (int l1 = j; l1 <= i1; ++l1)
				{
					for (int i2 = k; i2 <= j1; ++i2)
					{
						...
						if (j2 > 0)
						{
							...
							for (int j20 = 0; j20 < 30; ++j20)
							{
								int var4 = this.worldObj.getBlockId(k1, l1-1, i2);
							...
							if(j2 == 20 || j2 == 18){
							this.worldObj.setBlockMetadataWithNotify(k1, l1, i2, 0, 0);
							}
							this.setDead();
						}
					}
