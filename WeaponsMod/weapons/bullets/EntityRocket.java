...
public class EntityRocket extends Entity implements IProjectile
{
	...
	public EntityRocket(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
	...
	public EntityRocket(World par1World, EntityLiving par2EntityLiving, float par3)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = par2EntityLiving;
	 ...
	 public void setThrowableHeading(double par1, double par3, double par5, float par7, float par8)
	{
				 ...
				 if (movingobjectposition.entityHit != null)
				 {
					 ...
					 if(!this.worldObj.isRemote){
						 if(movingobjectposition.entityHit != this.shootingEntity){
							 ...
							 this.worldObj.createExplosion(this, hitentity.posX, hitentity.posY, hitentity.posZ, 10, true);
							 System.out.println("hit an enity");
						 }
					 }
				 ...
				 for (int l1 = j; l1 <= i1; ++l1)
				 {
					 for (int i2 = k; i2 <= j1; ++i2)
					 {
						 ...
						 if (j2 > 0)
						 {
							 ...
							 System.out.println("hit a block: " + this.inTile);
							 this.setDead();
	 ...
	 public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
	 {
		 if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
		 {
			 ...
			 if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.ingotIron, 1)))
			 {
				 flag = false;
			 }
