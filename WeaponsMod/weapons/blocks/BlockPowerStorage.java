...
public class BlockPowerStorage extends BlockContainer{
	private Random rand = new Random();
	public BlockPowerStorage(int id)
	{
		super(id, Material.iron);
		this.setUnlocalizedName("weaponPowerStorage");
	...
	{
		return new TileEntityPowerStorage();
	}
	@Override
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
        ...
        if (player.isSneaking())
            ...
            if (!world.isRemote) {
                ...
                if (tile != null) {
                    player.openGui(Weapons.instance, Weapons.guiPowerStorage, world, x, y, z);
                }
            }
